...
//		}
	...
	@Override
	public Optional<List<Invoice>> getInvoiceOfFarmer(int id)
			throws NoFarmersFoundExceptions, InvoiceNotFoundException, UserNotRegisteredException, NotDealerException {
		UserServiceImpl u = new UserServiceImpl();
...
//			throw new NoDealersFoundException();
//		}
		List<Invoice> list = irepo.findByFarmerId(id);
		if (list.isEmpty()) {
			throw new InvoiceNotFoundException();
		}
		return Optional.of(list);
